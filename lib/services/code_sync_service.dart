...
class CodeSyncService {
  ...
  Future<String> updateWidgetProperty({
    ...
    try {
      ...
      print('Error updating widget property: $e');
      return sourceCode;
    }
  }
  ...
  Future<Map<String, dynamic>> extractWidgetProperties({
    ...
    try {
      ...
      print('Error extracting widget properties: $e');
      return {};
    }
  }
  ...
  Future<String> insertWidget({
    ...
    try {
      ...
      print('Error inserting widget: $e');
      return sourceCode;
    }
  }
  ...
  Future<String> wrapWidget({
    ...
    try {
      ...
      final widgetCode = lines.sublist(startLine, endLine + 1);

      // Increase indentation of original widget
      final indentedWidget = widgetCode.map((line) {
