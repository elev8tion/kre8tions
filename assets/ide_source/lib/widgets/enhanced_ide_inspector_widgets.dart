...
/// Inspector banner at the top with keyboard shortcuts
class InspectorBanner extends StatelessWidget {
  final VoidCallback onClose;
  final bool isDeepSelectActive;

  const InspectorBanner({
    super.key,
    required this.onClose,
    this.isDeepSelectActive = false,
  });
    ...
    return Material(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              isDeepSelectActive ? Icons.gps_fixed : Icons.search,
              color: Colors.white,
              size: 18,
            ),
            ...
            Column(
              ...
              children: [
                Text(
                  isDeepSelectActive ? 'DEEP SELECT MODE' : 'Widget Inspector',
                  style: TextStyle(
                    color: Colors.white,
                ...
                Text(
                  isDeepSelectActive
                      ? 'Click to select smallest widget'
            ...
            _ShortcutChip(
              label: 'Z+Click',
              description: 'Deep',
              isActive: isDeepSelectActive,
            ),
            const SizedBox(width: 4),
            _ShortcutChip(label: 'Tab', description: 'Parent'),
            const SizedBox(width: 4),
            _ShortcutChip(label: 'Esc', description: 'Exit'),
            const SizedBox(width: 8),
            IconButton(
...
/// Small chip showing a keyboard shortcut
      ...
      child: Row(
        ...
        children: [
          Text(
            label,
            style: TextStyle(
              color: isActive ? Colors.yellow.shade100 : Colors.white,
              fontSize: 9,
              fontWeight: FontWeight.bold,
          ...
          Text(
            ...
            style: TextStyle(
              color: isActive
                  ? Colors.yellow.shade100.withValues(alpha: 0.9)
