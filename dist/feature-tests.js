...
class FeatureTests {
    ...
    async testFileTreeNavigation() {
        ...
        // Expand folder
        await this.page.click('[class*="folder-toggle"]').catch(() => console.log('  No folders to expand'));
        await this.page.waitForTimeout(300);
        // Click on file
        await this.page.click('[class*="file-item"]').catch(() => console.log('  No files to click'));
        await this.page.waitForTimeout(500);
    ...
    async testProjectManagement() {
        ...
        await this.page.click('[data-action="new-project"]').catch(() => console.log('  New project button not found'));
        await this.page.waitForTimeout(500);
    ...
    async testAIIntegration() {
        ...
        await this.page.waitForTimeout(500);
        // Type question
        await this.page.click('[class*="ai-input"]').catch(() => console.log('  AI input not found'));
...
//# sourceMappingURL=feature-tests.js.map